...
\subsection{Convergence presque partout} % (fold)
...
\end{theorem}
% subsection convergence_presque_partout (end)
...
\begin{definition}[$\lim\sup$ d'une suite d'ensembles]
...
A l'aide du $\lim\sup_{n\to∞}E_n(ε)$ nous allons caractériser l'ensemble de divergence $D$ de la suite $\{N_n\}_{n≥1}$ vers. $0$, c-a-d. la suite où $X_n$ ne converge pas vers $X=0$.
...
\begin{definition}[équivalente de convergence PP]
...
\chapter{Loi des grands nombres} % (fold)
...
\section{Théorèmes Limites} % (fold)
...
\begin{theorem}[Loi des grands nombre en norme $L^2$ (loi faible des grand numbers)]
...
\begin{theorem}[Loi forte des grandes nombres]
...
% section theoremes_limites (end)% chapter loi_des_grands_nombres (end)
\section{Ensemble total} % (fold)
